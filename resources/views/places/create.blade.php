        ...
        <form action="{{ route('places.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 form-group mb-3">
                    ...
                    <input name="category" value="{{ old('category') }}" class="form-control" placeholder="Cafe, Library, Park">
                </div>
                <div class="col-md-6 form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input name="address" value="{{ old('address') }}" class="form-control" placeholder="123 Street, City">
            </div>

            <div class="form-group mb-3">
                <label class="fw-bold">Website</label>
                <input name="website" value="{{ old('website') }}" class="form-control" placeholder="https://example.com">
            </div>

            <div class="form-group mb-3">
                <label class="fw-bold">Description</label>
                <textarea name="description" class="form-control" rows="4" placeholder="Write something about this place...">{{ old('description') }}</textarea>
            </div>
